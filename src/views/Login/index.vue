<template>
  <div class="login hw100">
    ...
    <div class="loginform">
      <h2 class="loginform-title">操作员登录</h2>
      <el-form
        :model="LoginData"
        status-icon
        :rules="rules"
        ...
        <el-form-item label="" prop="Mobile">
          <el-input type="text" v-model.number="LoginData.Mobile" placeholder="请输入手机号" clearable prefix-icon="el-icon-user-solid" autocomplete="off" ></el-input>
        </el-form-item>
        <el-form-item label="" prop="Password">
          <el-input type="password" v-model="LoginData.Password" placeholder="请输入密码" clearable prefix-icon="el-icon-lock" autocomplete="off"></el-input>
        </el-form-item>
        <el-checkbox v-model="autoLogin">一周内自动登录</el-checkbox>
        <el-button type="primary" @click.prevent="throttle">登录</el-button><br/>
    ...
    <div class="login-bottom">
      <p>
        ...
        <router-link to='/pact' style='color: #909399'>服务协议</router-link> |
        <router-link to='/state' style='color: #909399'>用户隐私声明</router-link> |
        <router-link to='/legalNotices' style='color: #909399'>法律声明</router-link> |
        <el-link type="info" :underline="false">版权声明</el-link> |
        <el-link type="info" :underline="false"> Copyright © 2011-2019 七叶电子 Powered by 21CN</el-link><br/>
        云服务经营许可证A2.B1.B2-20090001 文网文[2008]053号 |  京ICP备09031924号
      </p>
    </div>
  </div>
</template>
