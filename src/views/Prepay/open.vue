<template>
  <el-dialog
    ...
    <el-form :model="meter" label-position="left" label-width="80px" :rules="rules">
      ...
      <div class="grouping m0">
        ...
        <div class='grouping-content clearfix'>
          ...
          <el-button @click="charge" type="primary" size="small" :disabled="chargeEnable">开户充值</el-button>
          ...
          <el-form-item label="购电次数" prop="PayCount" size="small">
            <el-input v-model="meter.PayCount" :disabled="chargeEnable"></el-input>
          </el-form-item>
          <el-button type="primary" size="small" :disabled="chargeEnable">实时表底</el-button>
          <el-form-item label="当前余量" prop="Left" size="small" class='mr30'>
            <el-input v-model="meter.Left" disabled></el-input>
          </el-form-item>
          <el-form-item label="充值后余量" prop="PayLeft" size="small" class='last-mb'>
    ...
    <span slot="footer" class="dialog-footer">
      ...
      <el-button type="primary" @click="addPrePay('rules')" size='small'>确 定</el-button>
    </span>
    <review ref="showReview" :auditorArray="auditorArray" :meterInfo="meter" :currentMeter="currentMeter" :cause="1"/>
  </el-dialog>
  <!-- </Modal> -->
</template>
